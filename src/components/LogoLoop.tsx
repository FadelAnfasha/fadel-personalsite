  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const itemLabel = (item as any).label as string | undefined;
        ...
        return (
          <li
            className={cx(
              ...
              isVertical ? "mb-(--logoloop-gap)" : "mr-(--logoloop-gap)",
              scaleOnHover && "overflow-visible group/item",
              showLabel && itemLabel && "flex flex-col items-center gap-1.5",
            )}
            key={key}
            role="listitem"
          >
      ...
      [isVertical, scaleOnHover, renderItem, showLabel, labelClassName],
    );
